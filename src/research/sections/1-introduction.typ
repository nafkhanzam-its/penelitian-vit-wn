...
Sementara itu, ketika tanaman terserang penyakit pertama kali, tanaman tersebut memberikan respon awal terhadap penyakit tersebut dalam bentuk perubahan kandungan klorofil serta metabolisme sel dan degradasi jaringan @mahlein2017.
...
Karena kemampuannya tersebut, sensor hiperspektral menjadi populer di bidang pertanian dengan aplikasi dalam pengelolaan tanaman, pemantauan tanaman, pemetaan tanaman, dan deteksi penyakit tanaman @ang2021 @lei2021 @sonobe2021.
Sensor ini memberikan informasi spektral, yang dapat digunakan untuk menilai kesehatan tanaman dengan memantau kadar air, laju transpirasi daun, struktur jaringan, atau pigmentasi @plaza2009 @west2010.
Misalnya, penyakit atau stres dapat menyebabkan perubahan pigmentasi, reaksi hipersensitif, atau degradasi dinding sel @blackburn2007 @west2010.
...
Meskipun CNN bagus dalam menangkap fitur lokal, CNN memerlukan jaringan yang sangat dalam dengan banyak parameter yang dapat menyebabkan penyesuaian berlebihan untuk menangkap fitur global @peng2021.
